...
# ![](./assets/images/Right_Index_1_from_Cincinnati_Type_Foundry_1882.png) course info
...
You all have different starting points; for you to understand your process and growth is what I am after. See the [assessment](assessment) page. Also, the [schedule](schedule) page has details on what's happening when (notice also that the individual weeks are listed in the navigation bar at left under 'schedule'. Make sure to scroll!)
